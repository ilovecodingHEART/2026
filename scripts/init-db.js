...
if (count === 0) {
  ...
  for (const u of users) {
    ...
    profile.run(info.lastInsertRowid, u.about, u.status, '/local-assets/placeholder.svg');
  ...
  [
    ['Adopt Me!', 1, 'Raise pets, decorate your home, and roleplay with friends.', '/local-assets/placeholder.svg', 'Roleplay', 38900000000, 128000, 48],
    ['Brookhaven RP', 2, 'Hang out, own houses, and roleplay in a city.', '/local-assets/placeholder.svg', 'Town and City', 61500000000, 221000, 18],
    ['Tower of Hell', 1, 'Reach the top of randomly generated obbies.', '/local-assets/placeholder.svg', 'Obby', 24400000000, 44000, 20],
    ['Blox Fruits', 2, 'Train to become the strongest swordsman or fruit user.', '/local-assets/placeholder.svg', 'Adventure', 52000000000, 417000, 12]
  ...
  [
    ['Classic ROBLOX Fedora', 'Hat', 'A timeless fedora for classic avatars.', 900, 1, '/local-assets/placeholder.svg', 1],
    ['BOBLOX Shirt', 'Shirt', 'Archive-themed shirt.', 15, 2, '/local-assets/placeholder.svg', 0],
    ['Builder Cap', 'Hat', 'For creators and builders.', 50, 2, '/local-assets/placeholder.svg', 0],
    ['Dark Hoodie', 'Shirt', 'A dark-theme hoodie.', 25, 1, '/local-assets/placeholder.svg', 0]
  ...
  db.prepare('INSERT INTO groups (name, owner_user_id, description, emblem_url, member_count) VALUES (?, ?, ?, ?, ?)').run('uncannym enterprises', 2, 'A seed group reconstructed from the archived pages.', '/local-assets/placeholder.svg', 2);
